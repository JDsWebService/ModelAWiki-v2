...
<div class="modal fade" id="reportReplyModal" tabindex="-1" role="dialog" aria-labelledby="reportReplyLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header bg-warning text-white rounded-0">
				<h5 class="modal-title" id="reportReplyLabel">Report Forum Reply</h5>
			</div>
