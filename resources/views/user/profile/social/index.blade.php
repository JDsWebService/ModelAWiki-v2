...
@section('content')
	<div class="container mt-3">
		<div class="row justify-content-center">
			<div class="col-sm-4">
				<a href="{{ route('user.profile.social-links.create') }}" class="btn btn-block btn-sm btn-success">
							...
							@foreach($links as $link)
								<tr>
									...
									<td class="buttons" style="width: 15%;">
										{{ Form::open(['method'  => 'DELETE', 'route' => ['user.profile.social-links.destroy', $link->id]]) }}
											<a href="{{ route('user.profile.social-links.edit', $link->id) }}"><i class="far fa-edit"></i></a>&nbsp;&nbsp;
